 ...
 * connection) is out of scope for this module.
 */
...
interface OpFieldSpec {
  ...
  /** Required specs error when their ref env var is unset. Optional specs (v3.0 slackAppToken) are silently skipped instead. */
  required: boolean;
}
